...
export default function Listings({ listings }: { listings: ListingModel[] | null }) {

  if (listings === null || listings.length === 0) return <p className="text-gray-700 text-center">There are no items in your cart.</p>;
